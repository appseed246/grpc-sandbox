...
const file_api_hello_proto_rawDesc = "" +
	"\n" +
	"\x0fapi/hello.proto\x12\x05myapp\x1a\x1fgoogle/protobuf/timestamp.proto\"\"\n" +
	...
	"\x11HelloServerStream\x12\x13.myapp.HelloRequest\x1a\x14.myapp.HelloResponse0\x01B\n" +
